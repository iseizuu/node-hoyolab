...
export class DailyModule {
   ...
   * @throws {NodeHoyoError} - If the specified day is not a valid date in the current month or if the reward for the specified day is undefined.
   */
  async reward(day: number | null = null): Promise<IDailyReward> {
    ...
    if (
      ...
      throw new NodeHoyoError(`${day} is not a valid date in this month.`)
    }
