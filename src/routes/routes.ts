...
export const ZZZ_RECORD_CHARACTER_API = `${SG_ACT}/event/game_record_zzz/api/zzz/avatar/info`
export const ZZZ_RECORD_INDEX_API = `${SG_ACT}/event/game_record_zzz/api/zzz/index`
export const ZZZ_RECORD_ABYSS = `${SG_ACT}/event/game_record_zzz/api/zzz/abyss_detail`
export const ZZZ_RECORD_HOLLOW_ZERO = `${SG_ACT}/event/game_record_zzz/api/zzz/abyss_abstract`
export const ZZZ_RECORD_NOTE_API = `${SG_ACT}/event/game_record_zzz/api/zzz/note`
export const ZZZ_RECORD_SHIYU_DEFENSE = `${SG_ACT}/event/game_record_zzz/api/zzz/challenge`
